    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ background: 'var(--gradient-brand)', padding: '16px 20px 56px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', gap: 6, alignItems: 'center', marginBottom: 16 }}>
          {[0,1,2].map(i => (
            <div key={i} style={{
              ...
              width: i === 0 ? 24 : 8,
              background: i === 0 ? '#fff' : 'rgba(255,255,255,.35)',
        ...
        <p style={{ fontSize: 14, color: 'rgba(255,255,255,.8)', fontFamily: 'var(--font-body)' }}>
          Como vamos chamar o/a novo(a) integrante?
        </p>
      </div>

      {/* White sheet */}
      <div style={{
        background: '#fff', borderRadius: '28px 28px 0 0', marginTop: -28,
        flex: 1, padding: '28px 20px 32px', display: 'flex', flexDirection: 'column', gap: 24,
      }}>
        {/* Name input */}
        <div>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: 14, fontSize: 22, fontFamily: 'var(--font-display)', fontWeight: 700,
              color: 'var(--text-strong)', textAlign: 'center',
              background: '#fff',
            }}
          />
        </div>
            ...
            {GENDERS.map(g => (
              <button
                ...
                style={{
                  ...
                  borderColor: gender === g.value ? 'var(--accent)' : 'var(--border-subtle)',
                  background: gender === g.value ? 'var(--violet-50)' : '#fff',
              ...
              >
                ...
                <span style={{
                  ...
                  color: gender === g.value ? 'var(--accent)' : 'var(--text-muted)',
                }}>
                  {g.label}
                </span>
              </button>
        ...
        <Button fullWidth disabled={!name.trim()} onClick={handleNext} size="lg">
          Próximo →
        </Button>
      </div>
    </div>
